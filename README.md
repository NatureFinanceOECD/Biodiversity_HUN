In order to replicate the study, some raw data files must be placed within the relevant folders. Please refer to the data analysis handbook under "2_documentation" for further details.
